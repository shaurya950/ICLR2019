#from .layers.InceptionResnet import Residual
...
class HourglassNet(nn.Module):
  def __init__(self, nStack, nModules, nFeats, numOutput,n):
    ...
    for i in range(self.nStack):
      _hourglass.append(Hourglass(self.n, self.nModules, self.nFeats))
      for j in range(self.nModules):
